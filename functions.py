...
def detect_color():
    ...
    common_colors = {
        ...
        "Light_Red": ([0, 100, 150], [10, 255, 255]),
        "Blue": ([100, 100, 100], [130, 255, 255]),
        "Sky_Blue": ([100, 50, 100], [130, 255, 255]),
        "Dark_Blue": ([100, 100, 50], [130, 255, 100]),
        "Light_Blue": ([100, 100, 150], [130, 255, 255]),
        "Green": ([40, 100, 100], [80, 255, 255]),
        "Dark_Green": ([40, 100, 50], [80, 255, 100]),
        "Light_Green": ([40, 100, 150], [80, 255, 255]),
        "Yellow": ([20, 100, 100], [40, 255, 255]),
        "Dark_Yellow": ([20, 100, 50], [40, 255, 100]),
        "Light_Yellow": ([20, 100, 150], [40, 255, 255]),
        ...
        "Dark_Pink": ([160, 100, 50], [180, 255, 100]),
        "Light_Pink": ([160, 100, 150], [180, 255, 255]),
        "Brown": ([0, 50, 50], [20, 255, 255]),
        "Dark_Brown": ([0, 50, 25], [20, 255, 75]),
        "Light_Brown": ([0, 50, 75], [20, 255, 150]),
        "Gray": ([0, 0, 50], [180, 30, 255]),
        "Dark_Gray": ([0, 0, 25], [180, 15, 75]),
        "Light_Gray": ([0, 0, 75], [180, 45, 150]),
        "Black": ([0, 0, 0], [180, 255, 30]),
        "Dark_Black": ([0, 0, 0], [180, 255, 15]),
        "Light_Black": ([0, 0, 0], [180, 255, 45]),
